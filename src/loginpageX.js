...
class LoginPageX extends Component {       // HomePage:メインページ
  ...
  selectHome = () => {  this.props.history.push({ pathname: '/homepageX' });  }
...
export default withRouter(LoginPageX) // 画面遷移対象にするので、withRoute()を使う